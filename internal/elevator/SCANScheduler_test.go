...
func TestSCANSchedulerAssignsRequestInScanDirection(t *testing.T) {
	...
	system.PendingRequests = []Request{
		{Floor: 3, Direction: DirectionDown, Kind: RequestKindHall},
		{Floor: 8, Direction: DirectionUp, Kind: RequestKindHall},
	}
...
func TestSCANSchedulerReversesWhenNoRequestInScanDirection(t *testing.T) {
	...
	system.Elevators[0].ScanDirection = DirectionUp
	system.PendingRequests = []Request{
		{Floor: 4, Direction: DirectionDown, Kind: RequestKindHall},
	}
...
func TestSCANSchedulerAppendsUpRequestAlongTheWay(t *testing.T) {
	...
	system.PendingRequests = []Request{
		{Floor: 6, Direction: DirectionUp, Kind: RequestKindHall},
	}
	...
	if len(system.PendingRequests) != 0 {
		t.Fatalf("pending requests = %v, want empty", system.PendingRequests)
	}
}
...
func TestSCANSchedulerAppendsDownRequestAlongTheWay(t *testing.T) {
	...
	system.PendingRequests = []Request{
		{Floor: 8, Direction: DirectionDown, Kind: RequestKindHall},
	}
